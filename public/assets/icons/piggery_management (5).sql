...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2023 at 04:06 AM
...
--
ALTER TABLE ` tbl_inventory`
  ADD CONSTRAINT `FK_ tbl_inventory_tbl_categoryv2` FOREIGN KEY (`category_id`) REFERENCES `tbl_category` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
