...
import { RemoveObjective, RemoveObjectiveItem } from "@/hooks/usePlan";
  ...
  const { error, isLoading, isFetching, data, refetch } = useQuery(
    ...
    async () => {
      ...
      let response = await fetch(
        `${
          location.origin
        }/api/get/Plans/PlanObjectives/${page}/?&filter=${JSON.stringify(
          filter
        )}`,
        {
          method: "GET",
    ...
    <>
      <div className="w-full h-auto overflow-y-hidden">
        <div className="w-11/12  mx-auto flex flex-row">
          <p className="text-2xl text-base-content my-auto p-4">Objective List</p>
        </div>
                      ...
                      <td className="flex">
                        <div className="flex flex-row mx-auto">
                          <Link
                            ...
                            href={{
                              pathname:
                                "/plans_management/veterinarian/ListDays/ListObjectives/ListItems",
                              query: { id: item.plan_detail_objectives },
                            }}
                          >
                            View Items
                          </Link>
                          ...
                          <Link
                            ...
                            href={{
                              pathname:
                                "/plans_management/veterinarian/ListDays/ListObjectives/Update",
                              query: { id: item.plan_detail_objectives },
                            }}
                          >
                            Update
                          ...
                          <button
                            ...
                            onClick={async () => {
                              if (
                                ...
                                const returned = await RemoveObjective(
                                  item.plan_detail_objectives
                                );
