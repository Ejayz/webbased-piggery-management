                      ...
                      <button
                        ...
                        onClick={() => {
                          printJS({
                            ...
                            style:
                              "td { text-align: center; max-width: 150px;word-wrap: break-word; } @page { size: auto;  margin: 0mm; }",
                          });
                        }}
                      >
                        Print
                          ...
                          itemList.map((data: any, key: number) => {
                            return (
                              <tr key={key}>
                                ...
                                <td className="text-ellipsis overflow-hidden">{data.category_name}</td>
                                <td className="text-ellipsis overflow-hidden">{data.available_stocks}</td>
                              </tr>
                            );
                          })
                        )}
