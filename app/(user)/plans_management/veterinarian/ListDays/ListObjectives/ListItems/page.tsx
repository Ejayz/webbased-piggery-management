...
import { RemoveObjectiveItem } from "@/hooks/usePlan";
  ...
  const { error, isLoading, isFetching, data, refetch } = useQuery(
    ...
    async () => {
      ...
      let response = await fetch(
        `${
          location.origin
        }/api/get/Plans/PlanItems/${page}/?&filter=${JSON.stringify(filter)}`,
        {
          method: "GET",
          headers: headersList,
        }
                      ...
                      <td className="flex">
                        <div className="flex flex-row mx-auto">
                          <Link
                            ...
                            href={{
                              pathname:
                                "/plans_management/veterinarian/ListDays/ListObjectives/ListItems/Update",
                              query: { id: item.objective_item_detail },
                            }}
                          >
                            Edit Items
                          </Link>
                          ...
                          <button
                            ...
                            onClick={async () => {
                              if (
                                ...
                                const returned = await RemoveObjectiveItem(
                                  item.objective_item_detail
                                );
