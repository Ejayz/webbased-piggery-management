  ...
  const { isLoading, isFetching, data, refetch, error } = useQuery(
    ...
    async () => {
      const response = await fetch(
        `${location.origin}/api/get/Operation/getCageCheckList/getCheckListFeeding/?batch_id=${id}`
      );
    ...
    <>
      <div className="w-full h-auto overflow-y-hidden">
        <div className="w-full h-full flex flex-col lg:flex-row text-base-content">
          <div className="w-full lg:w-1/4 flex h-auto">
              ...
              <div className="w-11/12 mx-auto text-base-content">
                ...
                <div className="flex flex-col">
                  <div className="w-full flex flex-row">
                    ...
                    <span>
                      {DateTime.fromISO(OperationData?.data.operation[0].operation_date)
                        .setZone("Asia/Manila")
                  ...
                  <div className="w-full flex flex-row">
                    ...
                    <span>{OperationData?.data.operation[0].operation_name}</span>
                  </div>
                  <div className="w-full flex flex-row">
                    <span className="text-md font-bold font-mono w-5/12">
                      Operation Time:
