...
async function Ops() {
  ...
  try {
    ...
    const getBoarList =
      "select * from tbl_pig  INNER JOIN tbl_pig_history ON tbl_pig_history.pig_id = tbl_pig.pig_id where tbl_pig.is_exist='true' and tbl_pig_history.pig_status='active'";
